...
class MockChats {
    ...
    static let chats: [ChatUser] = [
        ...
        ChatUser(name: "Владислав", avatar: "chatAvatar2", messages: ["Привет, не знаешь в какой аудитории у нас сегодня философия?", "Сегодня же нашего \"Канта\" заменяют..", "Надеюсь он в курсе что мы сейчас проходим."]),
